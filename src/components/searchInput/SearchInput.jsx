...
const SearchInput = () => {
  return (
        <form className="h-full flex ">
            <input className="bg-[#F8F7F3] w-[419px] outline-none h-full px-4 text-sm rounded-tl-[0px] rounded-br-[24px] rounded-tr-[24px] rounded-bl-[0px]" type="text" placeholder="Поиск" />
